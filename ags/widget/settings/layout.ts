...
export default [
  ...
  Page(
    ...
    Group(
      ...
      Row({ opt: b.launcher.icon.size, title: 'Icon Size' }),
  ...
  Page(
    'General',
    icons.ui.settings,
    Group('Launcher', Row({ opt: al.iconSize, title: 'Icon Size' }), Row({ opt: al.width, title: 'Width' }), Row({ opt: al.maxItem, title: 'Max Items' })),
    Group(
      'Overview',
    ...
    Group('Clipboard', Row({ opt: clip.width, title: 'Width' }), Row({ opt: clip.margin, title: 'Margin' })),
  ),
] as const;
