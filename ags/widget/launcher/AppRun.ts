...
export const QuickAppButton = (app: Application) =>
  Widget.Button({
    hexpand: true,
...
export const Launcher = () => {
  ...
  const SeparatedAppItem = (app: Application) => Widget.Revealer({ attribute: { app } }, Widget.Box({ vertical: true }, Widget.Separator(), AppItem(app)));
